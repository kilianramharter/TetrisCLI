...
public struct Piece {
	...
	public Piece(List<(int, int)> structure, char color, (int, int) rectangularSize, int pieceId) {
		Structure = structure; Color = color; RectangularSize = rectangularSize; PieceId = pieceId;
	}
}